      ...
      <Container>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-800">
          <p className="text-center text-gray-500 dark:text-gray-400">
            &copy; {new Date().getFullYear()} MindfulMoment. All rights reserved. Made with <Heart size={16} by Samarth Shendre className="inline text-red-500" /> for mental health.
          </p>

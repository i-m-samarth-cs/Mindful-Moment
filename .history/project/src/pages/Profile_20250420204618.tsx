...
const Profile: React.FC = () => {
  const [profile, setProfile] = useState<ProfileData>({
    ...
    avatar: "https://via.placeholder.com/150", // You can use a real image URL here
    stats: {
      posts: 42,
      followers: 215,
      following: 183
        ...
        <div>
          <div className="bg-blue-600 text-white p-6">
            <div className="flex flex-col md:flex-row items-center">
              <div className="h-24 w-24 rounded-full overflow-hidden bg-gray-100 mb-4 md:mb-0 md:mr-6">
                <img
                  src={profile.avatar}
                  alt={profile.name}

  ...
  if (isConnected && address) {
    return (
      <Button 
        ...
        icon={<LogOut size={16} className="text-blue-600" />}
        className="text-blue-600 border-blue-500 hover:bg-blue-50 dark:text-blue-400 dark:border-blue-400 dark:hover:bg-blue-900/20"
      >
